...
set rc [catch {
  ...
  set_property ip_repo_paths d:/2048game/2048game.cache/ip [current_project]
  set_property ip_output_repo d:/2048game/2048game.cache/ip [current_project]
  add_files -quiet D:/2048game/2048game.runs/synth_1/game.dcp
...
set rc [catch {
  ...
  write_bitstream -force game.bit -bin_file
